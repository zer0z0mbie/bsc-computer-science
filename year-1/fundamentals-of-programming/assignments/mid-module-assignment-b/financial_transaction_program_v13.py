...
expenses_dict = {"Rent": rent, "Utilities": utilities, "Groceries": groceries, "Other Expense": other_expenses}
    ...
    if int(menu_option_chosen) == 1: # Add transactions
        ...
        if len(transactions) == 0:
            ...
            for transaction in transactions:
                print(f"- Transaction ID: {transaction} | Details: {transactions[transaction]}")
            print()
